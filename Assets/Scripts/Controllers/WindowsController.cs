...
public class WindowsController : MonoBehaviour, BaseController {
	...
	*/
	...
	public bool isJumpingPressed() {
		return Input.GetKeyDown(getJoystickButtonString(joystickNumber, 0));
	}
	...
	public bool interact() {
		return Input.GetKeyDown(getJoystickButtonString(joystickNumber, 2));
	}
